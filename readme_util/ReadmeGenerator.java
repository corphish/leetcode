...
public class ReadmeGenerator {
    ...
    private static String generateReadmeContents(SolutionParser parser) {
        ...
        for (SolutionGroup solutionGroup : parser.getData()) {
            ...
            for (Solution solution : solutionGroup.getSolutions()) {
                sb.append("|[")
                        ...
                        .append(solution.getLink() == null || solution.getLink().isEmpty() ? "-"
                                : "[" + solution.getLink() + "](" + solution.getLink() + ")")
                        .append("|\n");
            }
        ...
        sb.append("Thank you for checking out my solutions to these ").append(parser.getCount())
                .append(" leetcode problems. Let me know if any solution can be improved.\n");
